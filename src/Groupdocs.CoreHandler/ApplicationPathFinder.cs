...
namespace Groupdocs.Web.UI
{
    ...
    public class ApplicationPathFinder : IApplicationPathFinder
    {
        ...
        public string GetApplicationPath()
        {
            ...
            else
            {
                ...
                baseUrl = (string) application[Constants.GroupdocsBaseUrl];
        ...
        public string GetApplicationHost()
        {
            ...
            else
            {
                ...
                string baseUrl = (string) application[Constants.GroupdocsBaseUrl];
                if (baseUrl == null)
                {

(function($) {
    ...
    '</div>';
            ...
            "viewing": function (options) {
                ...
                root.attr("data-ng-groupdocs-viewing-scroll", "");
    ...
    '</div>';
            ...
            "initializationComponent": function () {
                return '<a class="new_head_tools_btn head_tool_dropdown_btn h_t_i_singlepage" data-ng-click="viewModel.toggleDropDownMenu(null, $event)" href="#" data-tooltip="View Mode" data-localize-tooltip="ViewMode"></a>' +
            ...
            "search": function (options) {
                ...
                root.attr("data-ng-groupdocs-visible", "viewModel.visible()");

(function ($) {
    ...
    '</div>';
            ...
            "viewing": function (options) {
                var root = options.documentSpace;
                root.attr("data-bind", "event: { scroll: function(item, e) { this.ScrollDocView(item, e); }, scrollstop: function(item, e) { this.ScrollDocViewEnd(item, e);e.returnValue = false;return true; } }");
    ...
    '</div>';
            ...
            "initializationComponent": function () {
                return '<a class="new_head_tools_btn head_tool_dropdown_btn h_t_i_singlepage" data-bind="click: toggleDropDownMenu" href="#" data-tooltip="View Mode" data-localize-tooltip="ViewMode"></a>' +
            ...
            "search": function (options) {
                ...
                root.attr("data-bind", "visible:visible");

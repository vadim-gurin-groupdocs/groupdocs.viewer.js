(function ($) {
    ...
    window.groupdocs.JavaScriptDocumentDescriptionWrapper = function(options) {
        this.options = $.extend(true, {},
            this.options,
            options);
        this.init();
    };
    $.extend(window.groupdocs.JavaScriptDocumentDescriptionWrapper.prototype, {

            ...
            if (options.enableViewerInit) {
                ...
                container.each(function () {
                    ...
                    '<div dir="ltr" class="groupdocs_viewer_wrapper grpdx ' + classWithNumber + /*browserDependentCssClass + */'">' +
                        ...
                        '   <div id=' + settings.docViewerId + ' class="doc_viewer" data-ng-scrollable data-bind="event: { scroll: function(item, e) { this.ScrollDocView(item, e); }, scrollstop: function(item, e) { this.ScrollDocViewEnd(item, e);e.returnValue = false;return true; } }">' +
                        '   </div>' +
